<script lang="ts">
	import * as Sheet from "$lib/shadcn//sheet/index.js";
...
{:else}
	...
	<div
		...
		class={cn(
			"w-(--sidebar-width) sticky top-16 bottom-0 z-10 hidden transition-[left,right,width] duration-200 ease-linear md:flex",
			side === "left"
